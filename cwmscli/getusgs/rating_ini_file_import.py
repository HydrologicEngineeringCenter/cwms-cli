            ...
            if fields[0] in rating_types.keys():
                ...
                if f'$(${rating_db_type})' in fields:
                    ...
                    try:
                        ...
                        logging.error('ERROR: rating specificataion could not be update')
                        rating_errors.append([rating_spec, rating_types[fields[0]]['db_disc']])
    logging.info(f'ERRORS: The following rating specifications could not be updated {rating_errors}')
